...
public class Settings {
    ...
    private static final String PATH_FROM_ROOT = "src/main/java/ru/javarush/cryptoanalyzer/sternard/";
    public static final String LOGS_DIRECTORY = PATH_FROM_ROOT+"logs";
    public static final String INFORMATION_MESSAGE_ICON = PATH_FROM_ROOT+"images/info.png";
