...
public class Settings {
    ...
    public static final String LOGS_DIRECTORY = "src/main/java/ru/javarush/cryptoanalyzer/sternard/logs";
    public static final String INFORMATION_MESSAGE_ICON = "src/main/java/ru/javarush/cryptoanalyzer/sternard/images/info.png";
    ...
    public static final String SOURCE_FILENAME = "source.txt";
